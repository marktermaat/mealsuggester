...
var Meals = exports.Meals = {
    init: function init(channel) {
        (0, _jquery2.default)('.js-meals').on("click", ".js-meal", function (event) {
            var mealname = (0, _jquery2.default)(event.currentTarget).children(".js-mealname").text();
            (0, _jquery2.default)(".js-newmealform input[name='name']").val(mealname);
        });
    }
};
});
...
var Channel = function () {
    function Channel() {
        ...
        var guardianToken = (0, _jquery2.default)('meta[name="guardian_token"]').attr('content');
        var userId = (0, _jquery2.default)('meta[name="user_id"]').attr('content');

        this.socket = new _phoenix.Socket("/socket", { params: { token: window.userToken, guardian_token: guardianToken } });
        this.socket.connect();
